...
from src.ui.auth import get_client_ip, get_fingerprint, is_vpn, render_vpn_block
from src.ui.layout import render_agents_strip, render_footer, render_hero, render_topbar
...
st.markdown(
    '<div style="height:1px;background:linear-gradient(90deg,transparent,rgba(56,189,248,0.2),transparent);margin:0 48px;"></div>',
